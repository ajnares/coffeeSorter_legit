...
print(classNames)
model = models.load_model('coffCNN.h5')
...
def gOneServo():
    move_to_position(stopperServo, 90)
...
def gTwoServo():
    move_to_position(stopperServo, 90)
    move_to_position(mainServo, 90)
    move_to_position(firServo, 90)
    move_to_position(secServo, 90)

def gThreeServo():
    move_to_position(stopperServo, 100)
    move_to_position(mainServo, 100)
    move_to_position(firServo, 100)
    move_to_position(secServo, 100)

def gFourServo():
    move_to_position(stopperServo, 180)
    move_to_position(mainServo, 180)
    move_to_position(firServo, 180)
    move_to_position(secServo, 180)
